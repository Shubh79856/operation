...
// TypeScript type for the function parameter (testName) as string
function logTestCaseStart(testName: string): void {
  logger.info(`\n🚀 Starting test case: ${testName} 🚀\n`);
}

function logTestCaseEnd(testName: string): void {
